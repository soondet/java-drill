...
window.CARDS_EXTRA = [
 ...
 },
 {
  ...
  "a": "StructuredTaskScope связывает дочерние задачи в одно дерево: они стартуют внутри одного scope и живут не дольше него. Если одна падает (ShutdownOnFailure) или одна успевает первой (ShutdownOnSuccess) — scope отменяет остальные через interrupt. join() блокирует родителя, пока все дети не завершатся, поэтому осиротевших задач не остаётся.",
